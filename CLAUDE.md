...
| mypy 기존 위반 baseline 동결 | B | pyproject.toml `[[tool.mypy.overrides]] ignore_errors=true` 로 CI 통과만 유지(잔여 69건/2파일 — pipeline·web_api_routes) | 파일별 점진 해소 후 override 목록에서 제거 |
